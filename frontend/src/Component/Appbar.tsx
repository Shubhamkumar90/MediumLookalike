...
export const Appbar=()=>{
    return <div className="border-b flex justify-between px-10 py-4">
        <Link to="/blogs" className="flex flex-col justify-center cursor-pointer text-3xl font-bold">Medium</Link>
        <Link to={"/publish"}>
        ...
        <div><Avatar name={localStorage.getItem("name")||"Anonymous"} size={"big"}></Avatar></div>
    </div>
}